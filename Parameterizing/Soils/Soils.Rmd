...
Feild[Feild[,1]>(-1999) & Feild[,1]<.05,]<-.05
plot(Feild)
WP[WP[,1]>(-1999),]<-WP[WP[,1]>(-1999),]/100
WP[WP[,1]>(-1999) & WP[,1]<.05,]<-.05
...
rast_IC_map<-writeRaster(new_wilt_raster, filename=new_output_file_name, datatype='FLT8S',overwrite=TRUE)#Th
